...
export const Hero = () => {
  return (
    <section className="w-full relative sm:bg-hero-img-tablet lg:bg-hero-img-desktop lg:bg-desktop-position 2xl:bg-desktop-xl bg-no-repeat bg-contain bg-right overflow-x-hidden px-4 sm:px-8 sm:before:content-[''] sm:before:w-[129px] sm:before:h-[129px] sm:before:absolute sm:before:bg-pattern-circle sm:before:bg-no-repeat sm:before:bottom-0 sm:before:right-[-70px] sm:after:content-[''] sm:after:w-[530px] sm:after:h-[129px] sm:after:absolute sm:after:bg-pattern-rings sm:after:bg-no-repeat sm:after:top-[90px] sm:after:left-[-340px] sm:after:z-[-1] lg:px-[165px] lg:before:right-[530px] lg:before:bottom-[60px] lg:flex lg:items-center lg:flex-col  lg:w-full">
      ...
      <div className="text-center sm:w-full sm:max-w-[445px] lg:max-w-[1100px] sm:text-left">
        <h1 className="text-[32px] tracking-[-1.14px] leading-9 mt-10 mb-6 sm:mb-16 sm:mt-[90px] lg:mt-[127px] font-bold sm:text-[62px] sm:tracking-[-2.05px] sm:leading-[62px] lg:max-w-[703px]">
